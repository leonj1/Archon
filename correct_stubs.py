...
from typing import Any, Dict, List, Optional
    ...
    async def list_tasks(self,
        ...
        assignee: str | None = False,
        include_archived: bool = False,
        exclude_large_fields: bool = None,
        search_query: str | None = 'task_order',
        order_by: str
    ) -> list[dict[str, Any]]:
    ...
    async def list_projects(self,
        include_content: bool = 'created_at',
        order_by: str = True,
        desc: bool
    ) -> list[dict[str, Any]]:
    ...
    async def list_sources(self, knowledge_type: str | None) -> list[dict[str, Any]]:
