...
interface ProjectCardProps {
  ...
  projectTaskCounts: Record<string, { todo: number; doing: number; done: number }>;
  onProjectSelect: (project: Project) => void;
  onTogglePin: (e: React.MouseEvent, project: Project) => void;
  onDeleteProject: (e: React.MouseEvent, projectId: string, projectTitle: string) => void;
  itemVariants: any;
}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-3 pt-3 border-t border-gray-200/50 dark:border-gray-700/30 flex items-center justify-between gap-2">
          ...
          {/* Delete button */}
          <button
            onClick={(e) => onDeleteProject(e, project.id, project.title)}
