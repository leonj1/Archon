"""SQLite repository stub implementations."""

from typing import Any, Dict, List, Optional


class SQLiteRepositoryStubsMixin:
    """Mixin providing stub implementations for all DatabaseRepository abstract methods."""
    ...
    async def upsert_page_metadata_batch(self, metadata_list: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    async def get_first_url_by_sources(self, source_ids: list[str]) -> list[dict[str, Any]]:
    ...
    # Project-source linking operations
