"""
REFACTORED _async_orchestrate_crawl METHOD

This is the refactored version that uses extracted orchestration services.
Copy this into crawling_service.py to replace the existing _async_orchestrate_crawl method.
"""
